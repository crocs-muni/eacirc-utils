...
rtt_prefix = 'ctr_seed_1fe40505e131963c_8gb_'
# def confs
config_base = {
...
hash2_funs = {
    ...
    'RIPEMD160': FunArgs(20, None, (7, 8, 9, 10)),
    'SHA1': FunArgs(20, None, (11, 12, 13, 14)),
    'SHA256': FunArgs(32, None, (5, 6, 7)),
...
block_funs = {
    ...
    #'RC4': FunArgs(16, 16, (1,)),
    'SIMON': FunArgs(16, 16, (13, 14, 15, 16, 17)),
    'SPECK': FunArgs(16, 16, (6, 7, 8, 9)),
    'SINGLE-DES': FunArgs(8, 8, (3, 4, 5, 6)),
    'TRIPLE-DES': FunArgs(8, 24, (1, 2, 3)),
    'TEA': FunArgs(8, 16, (2, 3, 4, 5)),
    'GOST': FunArgs(8, 32, (6, 7, 8, 9)),
