...
rtt_prefix = 'rpc_seed_1fe40505e131963c_8gb_'
# def confs
config_base = {
...
plaintext_target_stream = random_stream
...
# ph4 hotfix
hash2_funs = {
    'Gost': FunArgs(32, None, (1, 2)),
    'MD5': FunArgs(16, None, (3, 4, 5)),
    'RIPEMD160': FunArgs(20, None, (2, 3, 4, 5)),
    'SHA1': FunArgs(20, None, (4, 5, 6)),
    'SHA256': FunArgs(32, None, (3, 4, 5)),
...
block_funs = {
    'AES': FunArgs(16, 16, (1, 2)),
    'BLOWFISH': FunArgs(8, 32, (1, 2)),
    'MARS': FunArgs(16, 16, (0, 1)),
    'TWOFISH': FunArgs(16, 16, (1, 2)),
    'SERPENT': FunArgs(16, 16, (1, 2)),
    'RC6': FunArgs(16, 16, (1, 2)),
    #'RC4': FunArgs(16, 16, (1,)),
    'SIMON': FunArgs(16, 16, (1, 2, 3)),
    'SPECK': FunArgs(16, 16, (1, 2, 3)),
    'SINGLE-DES': FunArgs(8, 8, (1, 2, 3)),
    'TRIPLE-DES': FunArgs(8, 24, (1, 2)),
    'TEA': FunArgs(8, 16, (1, 2, 3)),
    'GOST': FunArgs(8, 32, (1, 2)),
    
    'ARIA': FunArgs(16, 16, (1, 2, 3)),
    'CAMELLIA': FunArgs(16, 16, (1, 2, 3)),
    'CAST': FunArgs(8, 16, (1, 2, 3)),
    'IDEA': FunArgs(8, 16, (1, 2, 3)),
    'SEED': FunArgs(16, 16, (1, 2, 3)),
}
block_default = {
    'type': 'block',
    'init-frequency': 'only-once',
...
def prepare_cfg(project, fun, rounds, tv_size, tv_num):
    ...
    with open(cfg_name, 'w') as f:
        ...
        current_cfg['tv-size'] = tv_size * 2
        current_cfg['tv-count'] = tv_num // 2
        ...
        if project == "estream":
            ...
            rnd_plt_ctx_stream['source'] = stream
            current_cfg['stream'] = rnd_plt_ctx_stream
