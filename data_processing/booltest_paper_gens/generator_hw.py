...
rtt_prefix = 'hw_seed_1fe40505e131963c_8gmb_'
# def confs
config_base = {
...
plaintext_target_stream = hw_stream
...
hash2_funs = {
    ...
    'MD5': FunArgs(16, None, (11, 12, 13, 14, 15, 16, 17, 18, 19)),
    'RIPEMD160': FunArgs(20, None, (11, 12, 13, 14, 15)),
    'SHA1': FunArgs(20, None, (14, 15, 16, 17)),
    'SHA256': FunArgs(32, None, (11, 12, 13, 14, 15)),
...
block_funs = {
    ...
    #'RC4': FunArgs(16, 16, (1,)),
    'SIMON': FunArgs(16, 16, (13, 14, 15, 16, 17, 18)),
    'SPECK': FunArgs(16, 16, (6, 7, 8, 9, 10, 11)),
    'SINGLE-DES': FunArgs(8, 8, (3, 4, 5, 6)),
    'TRIPLE-DES': FunArgs(8, 24, (1, 2, 3, 4)),
    'TEA': FunArgs(8, 16, (2, 3, 4, 5)),
    'GOST': FunArgs(8, 32, (7, 8, 9, 10)),
    
    'ARIA': FunArgs(16, 16, (1, 2, 3)),
    'CAMELLIA': FunArgs(16, 16, (1, 2, 3, 4)),
    'CAST': FunArgs(8, 16, (1, 2, 3, 4, 5)),
...
def prepare_cfg(project, fun, rounds, tv_size, tv_num):
    ...
    with open(cfg_name, 'w') as f:
        ...
        if project == "estream":
            ...
            if block_funs[fun].block_size == 8:
                tmp['hw'] = 6
            stream['source'] = tmp
            current_cfg['stream'] = stream
